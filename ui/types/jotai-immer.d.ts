declare module 'jotai/immer' {
   ...
   */
  export function atomWithImmer<Value = unknown>(initialValue: Value): WritableAtom<Value, any, any>;
  export function atomWithImmer<Value = unknown>(getter: () => Value): WritableAtom<Value, any, any>;
}
