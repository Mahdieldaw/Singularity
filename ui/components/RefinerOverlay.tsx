    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ marginBottom: '16px' }}>
          <h3 style={{ color: '#94a3b8', fontSize: '14px' }}>Explanation</h3>
          <p style={{ color: '#cbd5e1', margin: 0 }}>{refinerData.explanation}</p>
        </div>

        <div>
          <h3 style={{ color: '#94a3b8', fontSize: '14px' }}>Refined Prompt</h3>
          <div style={{
